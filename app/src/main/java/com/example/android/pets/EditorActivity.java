...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                if (!mPetHasChanged) {
                    //navigate back to Catalog Activity
    ...
    private void savePet(){
        ...
        if (mCurrentPetUri == null) {
            ...
            // long newRowId = db.insert(PetEntry.TABLE_NAME, null, values);     //directly works with DB.
            if (newURI == null) {
                Toast.makeText(this, "Error with saving pet", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, getString(R.string.pet_saved), Toast.LENGTH_SHORT).show();
                Log.i("Editor_Activity NEW PET", newURI.toString());
            }
        }else {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this,
                mCurrentPetUri,   // The content URI of the words table
